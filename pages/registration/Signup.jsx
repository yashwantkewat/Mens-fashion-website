            ...
            <div className="login_Form bg-blue-50 px-8 py-6 border border-blue-100 rounded-xl shadow-md">
                ...
                <div className="mb-3">
                    <input
                        ...
                        className='bg-pink-50 border border-blue-200 px-2 py-2 w-96 rounded-md outline-none placeholder-blue-200'
                    />
                </div>
                ...
                <div className="mb-3">
                    <input
                        ...
                        className='bg-blue-50 border border-pink-200 px-2 py-2 w-96 rounded-md outline-none placeholder-blue-200'
                    />
                </div>
