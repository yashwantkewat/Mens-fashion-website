...
const ProductInfo = () => {
    ...
    return (
        <Layout>
            <section className="py-5 lg:py-16 font-poppins dark:bg-gray-800"  style={{backgroundColor:"red"}} >
                {loading ?
                    <>
                                        ...
                                        <div className="flex flex-wrap items-center mb-6">
                                            {cartItems.some((p) => p.id === product.id)
                                                ...
                                                <button
                                                    ...
                                                    className="w-full px-4 py-3 text-center text-blue-600 bg-blue-100 border border-pink-600  hover:bg-blue-600 hover:text-gray-100  rounded-xl"
                                                >
                                                    Add to cart
                                                </button>
                                            }
